...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('input[type=tel]').addEventListener('keyup', function(event) {
        ...
        array.forEach(function (array) {
            ...
            switch (name) {
                ...
                case 'email':
                    ...
                    break;
                case 'PhoneNumber_countrycodeval':
        ...
        const {PhoneNumber_countrycodeval = false,} = object;

        var phoneLabel = document.querySelector('.phone-label');
        var isValidNumber = numberValidation(PhoneNumber_countrycodeval);
        console.clear();
...
*/
function numberValidation(PhoneNumber_countrycodeval) {
    if(!PhoneNumber_countrycodeval) return {valid: false};

    var inputVal = (PhoneNumber_countrycodeval.charAt(0) != "+") ? "+" + PhoneNumber_countrycodeval : PhoneNumber_countrycodeval;
    var dialCodeArray =  _getDialCode(inputVal);
